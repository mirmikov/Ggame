...
export interface Player {
  ...
  solvedTasks: string[];
  latestBuff?: string;
  qualifierStatus?: "waiting" | "active" | "holding" | "qualified" | "eliminated" | "";
  zoneSteps?: number;
...
export interface QualifierTeam {
  ...
  zoneSteps: number;
  captureProgress: number;
  status: "waiting" | "active" | "holding" | "qualified" | "eliminated";
}
...
export interface Room {
  ...
  qualifierTeams: Record<string, QualifierTeam>;
